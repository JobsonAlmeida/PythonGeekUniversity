...
# Em funções python, podemos ter nenhuma ou várias entrada. Em lambdas também 
...
# Se passarmos mais argumentos do que parâmetros esperado teremos TypeError
