...
# Decorator function é a própria função que decora outra função
# Decorator é a linha com @ e o nome da decorator funtion


# a função seja_educado é a função decorator nesse caso
# def seja_educado(funcao):
#     def sendo():
#         print("Foi um prazer conhecer você!")
#         funcao()
...
#
# # def saudacao():
# #     print("Seja bem-vidndo(a) à Geek University")
# #
# # # saudacao()
# #
# #
