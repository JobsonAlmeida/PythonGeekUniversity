...
# print(os.getcwd())
#
# print(os.path.isabs("C:/Users/jobso/PastaGeral/TI_Courses/PythonGeekUniversity/Project1/"))
...
print(arquivos[0].inode()) # inode é a numeração do arquivo ou diret´´orio na árevore hirarquia
