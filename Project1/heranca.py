...
class Cliente(Pessoa):
    """Cliente herda de Pessoa"""
    def __init__(self, nome, sobrenome, cpf, renda):
        # super().__init__(nome, sobrenome, cpf) # Esta é a forma mais comum de executar o método construtor da classe Pessoa
        Pessoa.__init__(self, nome, sobrenome, cpf) # Esta é uma outra forma de executar o método construtor da classe Pessoa
        self.__renda = renda
...
class Funcionario(Pessoa):
    ...
    def nome_completo(self):
        print(super().nome_completo()) # Lembrar que com o super eu consigo acessar qualquer método da superclasse
