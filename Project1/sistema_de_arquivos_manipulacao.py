...
# print(os.path.exists("./Project1/geek.txt"))
# print(os.path.exists("geek/university/geek2.py"))
# print(os.path.exists("C:/Users/jobso/PastaGeral/TI_Courses/PythonGeekUniversity/Project1/frutas.txt"))

#Criando arquivos

import os

# Forma 1 - Já cria e fecha o arquivo
open("arquivo-teste.txt", 'w').close()

# Forma 2 - Já cria e fecha o arquivo
open("arquivo-teste2.txt", 'a').close()

# Forma 3

with open("arquivo-teste3.txt", 'w') as arquivo:
    pass # pass é uma palavra especial que equivale a um bloco e indica para não fazer nada

# Forma 4 

#os.mkdir("Abc/DEF/GH") #cria apenas último diretório na cadeia de diretórios especificada. Se os diretórios
                       # anteriores não existir, lança um erro
os.makedirs("Abc/DEF/GH", exist_ok=True) # Cria todos os diretórios na cadeia de diretórios especificada.

# os.makedirs("templates2/novo2/outro2", exist_ok=True)

# open("templates2/novo2/outro2/teste.txt", "w").close()
...
# for arquivo in os.scandir("geek2/novo2"):
#     if arquivo.is_file():
#         print("caminho do arquivo removido: ", arquivo.path)
#         os.remove(arquivo.path)
#     # if not arquivo.is_file():
#     #     print("caminho do diretório removido: ", arquivo.path)
#     #     os.rmdir(arquivo.path)


# os.removedirs("geek2/novo2/dentrodenovo2")

# from send2trash import send2trash
#
# # os.remove("cesta1.txt")
# send2trash("cesta2.txt")

import tempfile

# # O with cria um contexto. Saiu do with, acabou tudp
# with tempfile.TemporaryDirectory() as tmp:
#     print(f'Criei o diretório temporário em {tmp}')
#     with open(os.path.join(tmp, 'arquivo_temporario.txt'), 'w') as arquivo:
